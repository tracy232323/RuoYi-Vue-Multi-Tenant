<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="日志编号" align="center" prop="operId" width="100px" /> -->
      <el-table-column label="系统模块" align="center" prop="title" width="100px" />
      <el-table-column label="操作类型" align="center" prop="businessType" :formatter="typeFormat" width="100px" />
      <el-table-column label="请求方式" align="center" prop="requestMethod" width="100px" />
      <el-table-column label="操作人员" align="center" prop="operName" width="100px" />
      <el-table-column label="操作内容" align="center" prop="operInfo" :show-overflow-tooltip="true" />
      <!-- <el-table-column
        label="操作状态"
        align="center"
        prop="status"
...
export default {
  ...
  created () {
    ...
    this.getDicts('sys_oper_type').then(response => {
      this.typeOptions = response.data.slice(0, 4)
    })
  ...
  methods: {
    ...
    getList () {
      ...
      this.loading = true
      list(this.addDateRange(nowState, this.dateRange)).then(
        response => {
