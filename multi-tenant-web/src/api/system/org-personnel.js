 ...
 * @returns 
 */
export function getNodeLogApi(providerId, nodeId) {
	return request({
		url: `/demo/get/node/log/${providerId}/${nodeId}`,
		method: 'get'
	})
}
 ...
 * @returns 
 */
export function getPositionLogApi(providerId, nodeId) {
	return request({
		url: `/demo/get/position/log/${providerId}/${nodeId}`,
		method: 'get'
	})
}
 ...
 * @returns 
 */
export function exportDerivePho(type, providerId, nodeId) {
	return request({
		url: `/demo/getNodeAllUser/${type}/${providerId}/${nodeId}/export`,
		method: 'get'
	})
}
